...
df_tr = pd.read_csv('/home/mebin/Disease-Symptom-Prediction-Chatbot-main/Medical_dataset/training.csv')
df_tt = pd.read_csv('/home/mebin/Disease-Symptom-Prediction-Chatbot-main/Medical_dataset/Testing.csv')
...
def getDescription():
    ...
    with open('/home/mebin/Disease-Symptom-Prediction-Chatbot-main/Medical_dataset/symptom_Description.csv') as csv_file:
...
def getSeverityDict():
    ...
    with open('/home/mebin/Disease-Symptom-Prediction-Chatbot-main/Medical_dataset/symptom_severity.csv') as csv_file:
...
def getprecautionDict():
    ...
    with open('/home/mebin/Disease-Symptom-Prediction-Chatbot-main/Medical_dataset/symptom_precaution.csv') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        line_count = 0
        for row in csv_reader:
